...
DriveTrain::DriveTrain() : Subsystem("DriveTrain") {
	...
	wheelLock = RobotMap::driveTrainWheelLock;
	targetLeft = RobotMap::driveTrainTargetLeft;
	sendTarget = RobotMap::driveTrainSendTarget;
	...
	CrabSpeedX = RobotMap::CrabSpeedX;
	CrabSpeedY = RobotMap::CrabSpeedY;
