...
DigitalOutput* RobotMap::driveTrainSendTarget = NULL;
...
CrabSpeed* RobotMap::CrabSpeedX = NULL;
CrabSpeed* RobotMap::CrabSpeedY = NULL;
CrabSpeed* RobotMap::CrabSpeedTwist = NULL;
PIDController* RobotMap::driveTrainDriveControlX = NULL;
PIDController* RobotMap::driveTrainDriveControlY = NULL;
...
void RobotMap::init() {
	...
	driveTrainTargetLeft = new DigitalInput(1, 6);
	lw->AddSensor("DriveTrain", "TargetLeft", driveTrainTargetLeft);
	
	driveTrainSendTarget = new DigitalOutput(1, 7);
	...
	CrabSpeedY = new CrabSpeed();
	CrabSpeedTwist = new CrabSpeed();
	
	driveTrainDriveControlX = new PIDController(0.05, 0.0, 0.0, driveTrainWheelX, CrabSpeedX, 0.02);
	driveTrainDriveControlX->SetAbsoluteTolerance(1.0);
	driveTrainDriveControlY = new PIDController(0.05, 0.0, 0.0, driveTrainWheelY, CrabSpeedY, 0.02);
	driveTrainDriveControlY->SetAbsoluteTolerance(1.0);
	driveTrainDriveControlTwist = new PIDController(0.01, 0.0, 0.0, driveTrainGyro, CrabSpeedTwist, 0.02);
	driveTrainDriveControlTwist->SetContinuous(true);
	driveTrainDriveControlTwist->SetInputRange(0.0,360.0);
}
